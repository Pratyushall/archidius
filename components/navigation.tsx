    ...
    <>
      <nav
        ...
        className={cn(
          ...
          "data-[scrolled=true]:bg-black/25 data-[scrolled=true]:backdrop-blur-2xl data-[scrolled=true]:backdrop-saturate-150",
          "data-[scrolled=true]:border-white/10 data-[scrolled=true]:shadow-[0_18px_44px_-24px_rgba(0,0,0,0.75)]"
        )}
      >
        <div
          className={cn(
        ...
        >
          ...
          <Link
            ...
            className={cn(
              ...
              "drop-shadow-[0_10px_28px_rgba(0,0,0,0.35)] hover:scale-[1.04] hover:rotate-[3deg]"
            )}
          >
            {centerLogoNode ? (
          ...
          <div className="justify-self-end">
            <button
              ...
              className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/20 bg-black/10 text-white shadow-[0_10px_28px_-18px_rgba(0,0,0,0.8)] backdrop-blur-xl transition duration-300 hover:bg-white/15"
            >
              {isOpen ? (
